...
public class TiposPrimitivos {
	public static void main(String[] args) {
		...
		byte variavelByte = 1; // o tipo byte, assim como os outros primitivos, não pode manter um estado de
								// ausência de valor. Lembrando que ausência de valor é representada pela
								// palavra null que significa nulo.
