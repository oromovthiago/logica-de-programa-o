...
public class ContatosControle {
	...
	static {
		...
		LISTA_CONTATOS.add(new Contato("1", "Ana", "1199988-7755"));
		LISTA_CONTATOS.add(new Contato("2", "Lucas", "1199988-4433"));
		LISTA_CONTATOS.add(new Contato("3", "Sonia", "1199988-2211"));
